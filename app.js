...
【記述ルール】
- **ニーズ**: 「〜〜だが、〜〜したい」という形式で記述。複数内容を/で区切らず1文にまとめる
- **長期目標**: 55文字以内で「〜〜できる」で終わる。複数内容を/で区切らず1文にまとめる
- **短期目標**: 55文字以内で「〜〜できる」で終わる
...
[
  {
    "categoryName": "カテゴリ名",
    "needs": "〜〜だが、〜〜したい（1文にまとめる）",
    "longTermGoal": "長期目標（55文字以内、〜〜できるで終わる、1文にまとめる）",
...
以下の4項目を日本語で提案してください：
1. ニーズ（生活全般の解決すべき課題）
   - **「〜〜だが、〜〜したい」という形式**で記述すること
   - 複数の内容を/で区切らず、**1つの文にまとめる**こと
2. 長期目標
   - **必ず55文字以内**で、「〜〜できる」で終わる文章にすること
   - 複数の内容を/で区切らず、**1つの文にまとめる**こと
